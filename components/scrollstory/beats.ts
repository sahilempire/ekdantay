...
export const BEATS: Beat[] = [
  ...
  },
  {
    ...
    eyebrow: 'Cosmetic',
    title: 'Whitening',
    body: 'Years of tea, coffee and tobacco sit in the enamel, not under it. A professional lift reaches what brushing cannot, without touching the tooth beneath.',
    readout: { label: 'Whitening', value: '₹3,500 / session' },
    camera: { x: -1.1, y: 0.4, z: 5.6 },
    offset: { x: -0.8, y: 0 },
    explode: 0,
    focus: null,
    bg: 'var(--surface)',
